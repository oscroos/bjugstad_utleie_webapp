...
VALUES ('cmic0pmax0000ume0vhr3dwol', 2228, 'user'),
  -- Belam Norge
  ('cmic0pmax0000ume0vhr3dwol', 1751, 'user'),
  -- Bane Nor
  ('cmic0pmax0000ume0vhr3dwol', 1075, 'admin') -- Volvo
  ON CONFLICT (user_id, customer_id) DO
UPDATE
